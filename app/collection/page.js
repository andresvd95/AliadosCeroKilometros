  ...
  const data = useMemo(() => ([
    {
      ...
      items: [
        ...
        },
        {
          ...
          images: [
            '/assets/images/vehiculos/orochCargo/orochCargo1.jpeg',
            '/assets/images/vehiculos/orochCargo/orochCargo2.jpeg',
            '/assets/images/vehiculos/orochCargo/orochCargo3.jpeg',
            '/assets/images/vehiculos/orochCargo/orochCargo4.jpeg',
            '/assets/images/vehiculos/orochCargo/orochCargo5.jpeg',
            '/assets/images/vehiculos/orochCargo/orochCargo6.jpeg',
          ],
          specs: [
            ['MODELO', '2026'],
            ['MOTOR', '1.3 / 1.300cc'],
      ...
      items: [
        {
          ...
          category: 'Carga',
          fuel: 'Diesel',
          price: 'Desde $81.130.000',
          images: [
            '/assets/images/vehiculos/berlingo/berlingo.png',
            '/assets/images/vehiculos/berlingo/berlingo.png',
            '/assets/images/vehiculos/berlingo/berlingo.png',
          ],
          specs: [
          ...
          wa: 'https://wa.me/573246492266?text=Hola%2C%20vengo%20del%20sitio%20web%2C%20quiero%20adquirir%20una%20Berlingo%20K9',
          pdf: '/assets/images/vehiculos/berlingo/FT%20Berlingo%20(2).pdf',
          pdfName: 'Ficha-Tecnica-Citroen-Berlingo-K9.pdf',
        },
      ],
    },
  ]), [])
  ...
  return (
    <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="VEHÍCULOS">
      ...
      <style jsx global>{`
        ...
        /* Flechas azules SIN cuadro SOLO en la mini imagen */
        .tf-product .image .swiper-button-prev,
        .tf-product .image .swiper-button-next{
          --swiper-navigation-size:26px;
          position:absolute; top:50%; transform:translateY(-50%);
          width:auto; height:auto; padding:0; line-height:1;
          color:#2aa8ff !important;
          background:none !important;
          border:none !important; outline:none !important;
          box-shadow:none !important; z-index:6; opacity:.95;
        }
        .tf-product .image .swiper-button-prev{ left:6px; }
        .tf-product .image .swiper-button-next{ right:6px; }
        .tf-product .image .swiper-button-prev::before,
        .tf-product .image .swiper-button-next::before{ content:none !important; }
        .tf-product .image .swiper-button-prev::after,
        .tf-product .image .swiper-button-next::after{ font-size:26px !important; color:#2aa8ff !important; text-shadow:none !important; }

        /* Toggle info: centrado + texto pequeño */
        ...
        /* Lightbox como en HTML de muestra */
