    ...
    return (
        <>
            ...
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="ROAD MAP">
                <section className=" section-roadmap2 section-bg-1">
                                    ...
                                    <div className="roadmap-box-2 left active wow fadeInLeft" data-wow-duration="1.5s">
                                        ...
                                        <div className="shape-circle">
                                            <svg xmlns="http://www.w3.org/2000/svg" width={176} height={60} viewBox="0 0 176 60" fill="none">
                                                ...
                                                <circle cx={146} cy={30} r={30} transform="rotate(90 146 30)" fill="#59d2fe" fillOpacity="0.2" />
                                                <circle cx={146} cy={30} r={15} transform="rotate(90 146 30)" fill="#59d2fe" />
                                            </svg>
                                        </div>
                                    </div>
                                    <div className="roadmap-box-2 right wow fadeInRight" data-wow-duration="1.5s">
                                        ...
                                        <div className="shape-circle">
                                            <svg xmlns="http://www.w3.org/2000/svg" width={176} height={60} viewBox="0 0 176 60" fill="none">
                                                ...
                                                <circle cx={30} cy={30} r={30} transform="rotate(-90 30 30)" fill="#59d2fe" fillOpacity="0.2" />
                                                <circle cx={30} cy={30} r={15} transform="rotate(-90 30 30)" fill="#59d2fe" />
                                            </svg>
                                        </div>
                                    </div>
